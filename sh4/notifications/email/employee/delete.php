...
class SH4_Notifications_Email_Employee_Delete implements SH4_Notifications_INotification
{
	...
	{
		$return = '__Email__' . ': ' . '__Shift Deleted__' . ' ('. '__Employee__' . ')';
		return $return;
	}
	...
	// if is linked to a user account
		...
		$this->notificator
			->queue( $user, 'email_employee_delete', $msg )
			;
	}
