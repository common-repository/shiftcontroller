...
class SH4_Notifications_Email_Manager_Reschedule implements SH4_Notifications_INotification
{
	...
	{
		$return = '__Email__' . ': ' . '__Shift Rescheduled__' . ' ('. '__Manager__' . ')';
		return $return;
	}
	...
	public function execute( SH4_Shifts_Model $shift, $template )
	{
		...
		foreach( $managers as $user ){
			$this->notificator
				->queue( $user, 'email_manager_reschedule', $msg )
				;
		}
	}
