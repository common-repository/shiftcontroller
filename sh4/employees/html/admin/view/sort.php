...
class SH4_Employees_Html_Admin_View_Sort
{
	public function __construct(
		...
		SH4_Employees_Presenter $presenter,
	...
	public function post()
	{
		...
		$ret = array( 'admin/employees', '__Sort Order Updated__' );
		return $ret;
	}
	...
	public function listingCell( $model )
	{
		...
		$titleView = $this->presenter->presentTitle( $model );
